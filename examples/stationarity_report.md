...
- Result: ❌ Non-stationary
- Note: Structural break detected: level shift at obs 99, trend shift at obs 155, level+trend shift at obs 99
- Interpretation: H0: Unit root with no break. ZA-c p=0.0040, ZA-t p=0.0285, ZA-ct p=0.0157 < 0.05. Structural break present.
- Statistic: -5.5103
- P-value: 0.0040
...
- Result: ❌ Non-stationary
- Note: Volatility clustering detected - consider GARCH modeling for variance (models time-varying variance)
...
- Result: ❌ Non-stationary
- Note: Seasonality detected (periods: 52) - consider seasonal differencing
- Interpretation: H0: No seasonality. ACF peak p=0.0000 <= 0.05. Reject H0.
- Statistic: 0.7508
- P-value: 0.0000
...
- Result: ✅ Stationary
- Note: No seasonal unit roots detected (period 52)
- Interpretation: H0: Seasonal unit roots present. CH p=0.0050 <= 0.05. Reject H0.
- Statistic: 36.5170
- P-value: 0.0050
...
- Result: ✅ Stationary
- Note: No seasonal unit roots detected (period 52)
- Interpretation: H0: Seasonal unit root present. OCSB t-stat=-7.6475 < -2.8600. Reject H0.
- Statistic: -7.6475
- P-value: 0.0050
...
- Result: ❌ Non-stationary
- Note: Periodic components detected (periods: 55.6, 17.4, 8.7) - consider seasonal differencing
- Interpretation: H0: No periodicity. Spectral peaks detected. Reject H0.
- Statistic: 760709.2235
- P-value: 0.0000
