...
- Result: ❌ Non-stationary
- Note: Seasonal unit roots detected (period 7) - consider seasonal differencing (may trigger on trend)
- Interpretation: H0: Seasonal unit root present. OCSB t-stat=-1.7068 >= -2.8600. Fail to reject H0.
- Statistic: -1.7068
- P-value: 0.1500
